...
KEYWORDS_WINDOWS95="Windows(| )95|Win95"
...
KEYWORDS_WINDOWS10="Windows(| )(10|Ten)|\bWin10"
...
KEYWORDS_WINDOWS_EXCLUDE="$KEYWORDS_ACTIVEDIRECTORY|$KEYWORDS_WINDOWSNT|$KEYWORDS_WINDOWS95|$KEYWORDS_WINDOWS98|$KEYWORDS_WINDOWS2000|$KEYWORDS_WINDOWSXP|$KEYWORDS_WINDOWSVISTA|$KEYWORDS_WINDOWS7|$KEYWORDS_WINDOWS8|$KEYWORDS_WINDOWS10|$KEYWORDS_WINDOWSSERVER2003|$KEYWORDS_WINDOWSSERVER2008|$KEYWORDS_WINDOWSMOVIEMAKER|\bX(-| )Windows|$KEYWORDS_WINDOWSMEDIAPLAYER"
...
then
  ...
  WINDOWS95=$(egrep -i "$KEYWORDS_WINDOWS95" "$NEWPAGES")

  categorize "WINDOWS95" "Windows 95"
  ...
  WINDOWS10=$(egrep -i "$KEYWORDS_WINDOWS10" "$NEWPAGES")

  categorize "WINDOWS10" "Windows 10"
