...
then
  ...
  MULTIMEDIA=$(egrep -i "$KEYWORDS_MULTIMEDIASOFTWARE|$KEYWORDS_MULTIMEDIASOFTWARE_OTHER" "$NEWPAGES" | egrep -iv "$KEYWORDS_MULTIMEDIASOFTWARE_EXCLUDE")

  categorize "MULTIMEDIA" "Multimedia software"
