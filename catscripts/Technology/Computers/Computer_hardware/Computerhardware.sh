...
KEYWORDS_DATASTORAGE="Data(| )storage|flash(| )drive|USB(| )drive|memory(| )stick|SD(| )card|SDHC"
...
KEYWORDS_COMPUTER_HARDWARE="Device driver|Computer hardware|adapter card" #Stuff to put in the parent category
