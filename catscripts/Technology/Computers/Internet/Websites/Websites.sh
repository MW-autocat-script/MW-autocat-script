...
then
  ...
  KEYWORDS_WEBSITE_EXCLUDE="$KEYWORDS_SEARCHENGINES_ALL|$KEYWORDS_SOCIALNETWORKING_ALL|$KEYWORDS_WIKIA|$KEYWORDS_WIKIANSWERS|$KEYWORDS_WIKIPEDIA"
  KEYWORDS_WEBSITE_ALL="$KEYWORDS_WEBSITE|$KEYWORDS_SEARCHENGINES_ALL|$KEYWORDS_SOCIALNETWORKING_ALL|$KEYWORDS_WIKIA|$KEYWORDS_WIKIANSWERS|$KEYWORDS_WIKIPEDIA"
