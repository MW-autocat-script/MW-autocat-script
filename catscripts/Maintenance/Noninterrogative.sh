...
KEYWORDS_INTERROGATIVE="$KEYWORDS_WHO|$KEYWORDS_WHAT|$KEYWORDS_WHERE|$KEYWORDS_WHEN|$KEYWORDS_WHY|$KEYWORDS_HOW|$KEYWORDS_DO|$KEYWORDS_HAS|$KEYWORDS_HASNT|$KEYWORDS_DOES|$KEYWORDS_DOESNT|$KEYWORDS_DID|$KEYWORDS_DIDNT|$KEYWORDS_WILL|$KEYWORDS_IS|$KEYWORDS_ISNT|$KEYWORDS_ARE|$KEYWORDS_ARENT|$KEYWORDS_WERE|$KEYWORDS_WAS|$KEYWORDS_WHICH|$KEYWORDS_COULD|$KEYWORDS_SHOULD|$KEYWORDS_SHOULDNT|$KEYWORDS_WOULD|$KEYWORDS_CAN|$KEYWORDS_CANT|$KEYWORDS_AMI|$KEYWORDS_HAVE"
