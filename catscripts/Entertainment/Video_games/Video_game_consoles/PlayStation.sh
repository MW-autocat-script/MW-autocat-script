...
KEYWORDS_PS1_EXCLUDE="Play(| )Station(| )(2|3|4|5|6|7|8|9|10|Network)|\bPSN\b|PlayStation(| )Portable|PlayStation(| )Vita" # If this script is still being used when the PlayStation 11 comes out, I will kill myself
