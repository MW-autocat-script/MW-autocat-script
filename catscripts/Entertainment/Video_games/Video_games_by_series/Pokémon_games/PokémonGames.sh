...
KEYWORDS_POKEMONSUN="(Pokemon|Pokémon|Poke'mon)(| )Sun\b"
KEYWORDS_POKEMONMOON="(Pokemon|Pokémon|Poke'mon)(| )Moon\b"
...
KEYWORDS_POKEMONGAMES_6="$KEYWORDS_POKEMONX|$KEYWORDS_POKEMONY|$KEYWORDS_POKEMONALPHASAPPHIRE|$KEYWORDS_POKEMONOMEGARUBY|$KEYWORDS_POKEMONSUN|$KEYWORDS_POKEMONMOON"
...
then
  ...
  MOON=$(egrep -i "$KEYWORDS_POKEMONMOON" "$NEWPAGES")
  SUN=$(egrep -i "$KEYWORDS_POKEMONSUN" "$NEWPAGES")
  ...
  categorize "MOON" "Pokémon Moon"
  categorize "SUN" "Pokémon Sun"
