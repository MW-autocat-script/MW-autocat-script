...
. $CURRENTDIR/MapleStory/MapleStory.sh
...
export KEYWORDS_MMORPG="$KEYWORDS_MMORPG_AQW|$KEYWORDS_MMORPG_ANARCHY|$KEYWORDS_MMORPG_CABAL|$KEYWORDS_MMORPG_FRONTIER|$KEYWORDS_MMORPG_DOFUS|$KEYWORDS_MMORPG_EVE|$KEYWORDS_MMORPG_FANTAGE|$KEYWORDS_MMORPG_FIESTA|$KEYWORDS_MMORPG_FLYFF|$KEYWORDS_MMORPG_FREEREALMS|$KEYWORDS_MMORPG_GHOSTX|$KEYWORDS_MMORPG_GUILDWARS|$KEYWORDS_MMORPG_KAROS|$KEYWORDS_MMORPG_MAFIA|$KEYWORDS_MMORPG_MAPLESTORY|$KEYWORDS_MMORPG_PANFU|$KEYWORDS_MMORPG_POPTROPICA|$KEYWORDS_MMORPG_RUNESOFMAGIC|$KEYWORDS_MMORPG_RUNESCAPE|$KEYWORD_MMORPG_SACRED|$KEYWORDS_MMORPG_SWTOR|$KEYWORDS_MMORPG_PIRATES|$KEYWORDS_MMORPG_TALISMAN|$KEYWORDS_MMORPG_WIZARD101|$KEYWORDS_MMORPG_WOW"
