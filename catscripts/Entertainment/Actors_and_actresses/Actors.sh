...
then
  ...
  KEYWORDS_ACTRESS="$KEYWORDS_ACTRESS_SANDRABULLOCK|$KEYWORDS_ACTRESS_MEGANFOX|$KEYWORDS_ACTRESS_SELENAGOMEZ|$KEYWORDS_ACTRESS_MARILYNMONROE|$KEYWORDS_EMMAWATSON_ALL|$KEYWORDS_ZENDAYA"
