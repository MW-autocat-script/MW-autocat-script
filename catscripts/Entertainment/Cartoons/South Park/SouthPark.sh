...
SOUTHPARK_EPISODES="Make(| )Love(|,)(| )Not(| )Warcraft|Good(| )Times(| )With Weapons|The Coon\b|Imaginationland|Insheeption|Ass Burgers|Kenny Dies|Mecha-Streisand|Trapped in the Closet|Lice(| )Capades|You Have 0 Friends|Mystery of the Urinal Deuce|Up the Down Steroid"
