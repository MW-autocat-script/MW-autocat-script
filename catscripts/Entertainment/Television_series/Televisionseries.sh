...
then 
  ...
  KEYWORDS_TELEVISIONSERIES_EXCLUDE="$KEYWORDS_DESPERATEHOUSEWIVES|$KEYWORDS_TELEVISIONSERIES_ICARLY|$KEYWORDS_DOCTORWHO|$KEYWORDS_SMALLVILLE|$KEYWORDS_TOPGEAR|$KEYWORDS_TORCHWOOD_ALL"
