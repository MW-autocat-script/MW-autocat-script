...
KEYWORDS_POKEMONSPECIES_P="$KEYWORDS_PACHIRISU|$KEYWORDS_PALKIA|$KEYWORDS_PALPITOAD|$KEYWORDS_PANPOUR|$KEYWORDS_PANSAGE|$KEYWORDS_PANSEAR|$KEYWORDS_PARAS|$KEYWORDS_PARASECT|$KEYWORDS_PATRAT|$KEYWORDS_PAWNIARD|$KEYWORDS_PELIPPER|$KEYWORDS_PERSIAN|$KEYWORDS_PETILIL|$KEYWORDS_PHANPY|$KEYWORDS_PHIONE|$KEYWORDS_PICHU|$KEYWORDS_PIDGEOT|$KEYWORDS_PIDGEOTTO|$KEYWORDS_PIDGEY|$KEYWORDS_PIDOVE|$KEYWORDS_PIGNITE|$KEYWORDS_PIKACHU|$KEYWORDS_PILOSWINE|$KEYWORDS_PINECO|$KEYWORDS_PINSIR|$KEYWORDS_PIPLUP|$KEYWORDS_PLUSLE|$KEYWORDS_POLITOED|$KEYWORDS_POLIWAG|$KEYWORDS_POLIWHIRL|$KEYWORDS_POLIWRATH|$KEYWORDS_PONYTA|$KEYWORDS_POOCHYENA|$KEYWORDS_PORYGON|$KEYWORDS_PORYGON2|$KEYWORDS_PORYGONZ|$KEYWORDS_PRIMEAPE|$KEYWORDS_PRINPLUP|$KEYWORDS_PROBOPASS|$KEYWORDS_PSYDUCK|$KEYWORDS_PUPITAR|$KEYWORDS_PURRLOIN|$KEYWORDS_PURUGLY"
