...
then
  ...
  WAILMER=$(egrep -i "$KEYWORDS_WAILMER" newpages.txt)
  WAILORD=$(egrep -i "$KEYWORDS_WAILORD" newpages.txt)
  WALREIN=$(egrep -i "$KEYWORDS_WALREIN" newpages.txt)
  WARTORTLE=$(egrep -i "$KEYWORDS_WARTORTLE" newpages.txt)
  WATCHOG=$(egrep -i "$KEYWORDS_WATCHOG" newpages.txt)
  WEAVILE=$(egrep -i "$KEYWORDS_WEAVILE" newpages.txt)
  WEEDLE=$(egrep -i "$KEYWORDS_WEEDLE" newpages.txt)
  WEEPINBELL=$(egrep -i "$KEYWORDS_WEEPINBELL" newpages.txt)
  WEEZING=$(egrep -i "$KEYWORDS_WEEZING" newpages.txt)
  WHIMSICOTT=$(egrep -i "$KEYWORDS_WHIMSICOTT" newpages.txt)
  WHIRLIPEDE=$(egrep -i "$KEYWORDS_WHIRLIPEDE" newpages.txt)
  WHISCASH=$(egrep -i "$KEYWORDS_WHISCASH" newpages.txt)
  WHISMUR=$(egrep -i "$KEYWORDS_WHISMUR" newpages.txt)
  WIGGLYTUFF=$(egrep -i "$KEYWORDS_WIGGLYTUFF" newpages.txt)
  WINGULL=$(egrep -i "$KEYWORDS_WINGULL" newpages.txt)
  WOBUFFET=$(egrep -i "$KEYWORDS_WOBUFFET" newpages.txt)
  WOOBAT=$(egrep -i "$KEYWORDS_WOOBAT" newpages.txt)
  WOOPER=$(egrep -i "$KEYWORDS_WOOPER" newpages.txt)
  WORMADAM=$(egrep -i "$KEYWORDS_WORMADAM" newpages.txt)
  WURMPLE=$(egrep -i "$KEYWORDS_WURMPLE" newpages.txt)
  WYNAUT=$(egrep -i "$KEYWORDS_WYNAUT" newpages.txt)
