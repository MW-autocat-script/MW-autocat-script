...
KEYWORDS_NOIBAT="Noibat"
KEYWORDS_NOIVERN="Noivern"
KEYWORDS_NOSEPASS="Nosepass"
KEYWORDS_NUMEL="Numel"
KEYWORDS_NUZLEAF="Nuzleaf"
KEYWORDS_POKEMONSPECIES_N="$KEYWORDS_NATU|$KEYWORDS_NIDOKING|$KEYWORDS_NIDOQUEEN|$KEYWORDS_NIDORAN_NONSPECIFIC|$KEYWORDS_NIDORINA|$KEYWORDS_NIDORINO|$KEYWORDS_NINCADA|$KEYWORDS_NINETALES|$KEYWORDS_NINJASK|$KEYWORDS_NOCTOWL|$KEYWORDS_NOIBAT|$KEYWORDS_NOIVERN|$KEYWORDS_NOSEPASS|$KEYWORDS_NUMEL|$KEYWORDS_NUZLEAF"
...
then
  ...
  NOIBAT=$(egrep -i "$KEYWORDS_NOIBAT" "$NEWPAGES")

  categorize "NOIBAT" "Noibat"

  NOIVERN=$(egrep -i "$KEYWORDS_NOIVERN" "$NEWPAGES")

  categorize "NOIVERN" "Noivern"
