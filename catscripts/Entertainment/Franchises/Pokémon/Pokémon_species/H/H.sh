...
KEYWORDS_POKEMONSPECIES_H="$KEYWORDS_HAPPINY|$KEYWORDS_HARIYAMA|$KEYWORDS_HAUNTER|$KEYWORDS_HAXORUS|$KEYWORDS_HEATMOR|$KEYWORDS_HEATRAN|$KEYWORDS_HERACROSS|$KEYWORDS_HERDIER|$KEYWORDS_HIPPOPOTAS|$KEYWORDS_HIPPOWDON|$KEYWORDS_HITMONCHAN|$KEYWORDS_HITMONLEE|$KEYWORDS_HITMONTOP|$KEYWORDS_HONCHKROW|$KEYWORDS_HOOH|$KEYWORDS_HOOPA|$KEYWORDS_HOOTHOOT|$KEYWORDS_HOPPIP|$KEYWORDS_HORSEA|$KEYWORDS_HOUNDOOM|$KEYWORDS_HOUNDOUR|$KEYWORDS_HUNTAIL|$KEYWORDS_HYDREIGON|$KEYWORDS_HYPNO"
...
then
  ...
  HOOPA=$(egrep -i "$KEYWORDS_HOOPA" "$NEWPAGES")
