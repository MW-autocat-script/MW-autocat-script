...
then
  ...
  egrep -i "$KEYWORDS_CARBINK" newpages.txt >> Carbink.txt &
  ...
  egrep -i "$KEYWORDS_CHESNAUGHT" newpages.txt >> Chesnaught.txt &
  ...
  egrep -i "$KEYWORDS_CLAUNCHER" newpages.txt >> Clauncher.txt &
  ...
  CARBINK=`stat --print=%s Carbink.txt`
  ...
  CHESNAUGHT=`stat --print=%s Chesnaught.txt`
  ...
  CLAUNCHER=`stat --print=%s Clauncher.txt` 
