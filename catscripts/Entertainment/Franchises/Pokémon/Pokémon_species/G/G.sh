...
KEYWORDS_POKEMONSPECIES_G="$KEYWORDS_GABITE|$KEYWORDS_GALLADE|$KEYWORDS_GALVANTULA|$KEYWORDS_GARBODOR|$KEYWORDS_GARCHOMP|$KEYWORDS_GARDEVOIR|$KEYWORDS_GASTLY|$KEYWORDS_GASTRODON|$KEYWORDS_GENESECT|$KEYWORDS_GENGAR|$KEYWORDS_GEODUDE|$KEYWORDS_GIBLE|$KEYWORDS_GIGALITH|$KEYWORDS_GIRAFARIG|$KEYWORDS_GIRATINA|$KEYWORDS_GLACEON|$KEYWORDS_GLALIE|$KEYWORDS_GLAMEOW|$KEYWORDS_GLAMEOW|$KEYWORDS_GLIGAR|$KEYWORDS_GLIGAR|$KEYWORDS_GLISCOR|$KEYWORDS_GLOOM|$KEYWORDS_GOGOAT|$KEYWORDS_GOLBAT|$KEYWORDS_GOLDEEN|$KEYWORDS_GOLDUCK|$KEYWORDS_GOLEM|$KEYWORDS_GOLETT|$KEYWORDS_GOLURK|$KEYWORDS_GOODRA|$KEYWORDS_GOOMY|$KEYWORDS_GOREBYSS|$KEYWORDS_GOREBYSS|$KEYWORDS_GOTHITA|$KEYWORDS_GOTHITELLE|$KEYWORDS_GOTHORITA|$KEYWORDS_GOURGEIST|$KEYWORDS_GRANBULL|$KEYWORDS_GRAVELER|$KEYWORDS_GRENINJA|$KEYWORDS_GRIMER|$KEYWORDS_GROTLE|$KEYWORDS_GROUDON|$KEYWORDS_GROVYLE|$KEYWORDS_GROWLITHE|$KEYWORDS_GRUMPIG|$KEYWORDS_GULPIN|$KEYWORDS_GURDURR|$KEYWORDS_GYARADOS"
...
then
  ...
  GOGOAT=$(egrep -i "$KEYWORDS_GOGOAT" "$NEWPAGES")
  ...
  GOODRA=$(egrep -i "$KEYWORDS_GOODRA" "$NEWPAGES")
  GOOMY=$(egrep -i "$KEYWORDS_GOOMY" "$NEWPAGES")
  ...
  GOURGEIST=$(egrep -i "$KEYWORDS_GOURGEIST" "$NEWPAGES")
  GRANBULL=$(egrep -i "$KEYWORDS_GRANBULL" "$NEWPAGES")
  GRAVELER=$(egrep -i "$KEYWORDS_GRAVELER" "$NEWPAGES")
  GRENINJA=$(egrep -i "$KEYWORDS_GRENINJA" "$NEWPAGES")
