...
KEYWORDS_ZYGARDE="Zygarde"

KEYWORDS_POKEMONSPECIES_Z="$KEYWORDS_ZANGOOSE|$KEYWORDS_ZAPDOS|$KEYWORDS_ZEBSTRIKA|$KEYWORDS_ZEKROM|$KEYWORDS_ZIGZAGOON|$KEYWORDS_ZOROARK|$KEYWORDS_ZORUA|$KEYWORDS_ZUBAT|$KEYWORDS_ZWEILOUS|$KEYWORDS_ZYGARDE"
...
then
  ...
  ZYGARDE=$(egrep -i "$KEYWORDS_ZYGARDE" "$NEWPAGES")
