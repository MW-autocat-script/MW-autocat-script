...
KEYWORDS_POKEMONSPECIES_M="$KEYWORDS_MACHAMP|$KEYWORDS_MACHOKE|$KEYWORDS_MACHOP|$KEYWORDS_MAGBY|$KEYWORDS_MAGCARGO|$KEYWORDS_MAGIKARP|$KEYWORDS_MAGMAR|$KEYWORDS_MAGMORTAR|$KEYWORDS_MAGNEMITE|$KEYWORDS_MAGNETON|$KEYWORDS_MAGNEZONE|$KEYWORDS_MAKUHITA|$KEYWORDS_MAMOSWINE|$KEYWORDS_MAMOSWINE|$KEYWORDS_MANAPHY|$KEYWORDS_MANDIBUZZ|$KEYWORDS_MANECTRIC|$KEYWORDS_MANKEY|$KEYWORDS_MANTINE|$KEYWORDS_MANTYKE|$KEYWORDS_MARACTUS|$KEYWORDS_MAREEP|$KEYWORDS_MARILL|$KEYWORDS_MAROWAK|$KEYWORDS_MARSHTOMP|$KEYWORDS_MASQUERAIN|$KEYWORDS_MAWILE|$KEYWORDS_MEDICHAM|$KEYWORDS_MEDITITE|$KEYWORDS_MEGANIUM|$KEYWORDS_MELOETTA|$KEYWORDS_MEOWTH|$KEYWORDS_MESPRIT|$KEYWORDS_METAGROSS|$KEYWORDS_METANG|$KEYWORDS_METAPOD|$KEYWORDS_MEW|$KEYWORDS_MEWTWO|$KEYWORDS_MIENFOO|$KEYWORDS_MIENSHAO|$KEYWORDS_MIGHTYENA|$KEYWORDS_MILOTIC|$KEYWORDS_MILTANK|$KEYWORDS_MIMEJR|$KEYWORDS_MINCCINO|$KEYWORDS_MINUN|$KEYWORDS_MISDREAVUS|$KEYWORDS_MISMAGIUS|$KEYWORDS_MISMAGIUS|$KEYWORDS_MOLTRES|$KEYWORDS_MONFERNO|$KEYWORDS_MOTHIM|$KEYWORDS_MRMIME|$KEYWORDS_MUDKIP|$KEYWORDS_MUK|$KEYWORDS_MUNCHLAX|$KEYWORDS_MUNNA|$KEYWORDS_MURKROW|$KEYWORDS_MUSHARNA"
