...
KEYWORDS_POKEMONSPECIES_S="$KEYWORDS_SABLEYE|$KEYWORDS_SALAMENCE|$KEYWORDS_SAMUROTT|$KEYWORDS_SANDILE|$KEYWORDS_SANDSHREW|$KEYWORDS_SANDSLASH|$KEYWORDS_SAWK|$KEYWORDS_SAWSBUCK|$KEYWORDS_SCEPTILE|$KEYWORDS_SCIZOR|$KEYWORDS_SCOLIPEDE|$KEYWORDS_SCRAFTY|$KEYWORDS_SCRAGGY|$KEYWORDS_SCYTHER|$KEYWORDS_SEADRA|$KEYWORDS_SEAKING|$KEYWORDS_SEALEO|$KEYWORDS_SEEDOT|$KEYWORDS_SEEL|$KEYWORDS_SEISMITOAD|$KEYWORDS_SEISMITOAD|$KEYWORDS_SENTRET|$KEYWORDS_SERPERIOR|$KEYWORDS_SERVINE|$KEYWORDS_SEVIPER|$KEYWORDS_SEWADDLE|$KEYWORDS_SHARPEDO|$KEYWORDS_SHAYMIN|$KEYWORDS_SHEDINJA|$KEYWORDS_SHELGON|$KEYWORDS_SHELLDER|$KEYWORDS_SHELLOS|$KEYWORDS_SHELMET|$KEYWORDS_SHIELDON|$KEYWORDS_SHIFTRY|$KEYWORDS_SHINX|$KEYWORDS_SHROOMISH|$KEYWORDS_SHUCKLE|$KEYWORDS_SHUPPET|$KEYWORDS_SIGILYPH|$KEYWORDS_SILCOON|$KEYWORDS_SIMIPOUR|$KEYWORDS_SIMISAGE|$KEYWORDS_SIMISEAR|$KEYWORDS_SKARMORY|$KEYWORDS_SKIPLOOM|$KEYWORDS_SKITTY|$KEYWORDS_SKORUPI|$KEYWORDS_SKORUPI|$KEYWORDS_SKUNTANK|$KEYWORDS_SLAKING|$KEYWORDS_SLAKOTH|$KEYWORDS_SLOWBRO|$KEYWORDS_SLOWKING|$KEYWORDS_SLOWPOKE|$KEYWORDS_SLUGMA|$KEYWORDS_SMEARGLE|$KEYWORDS_SMOOCHUM|$KEYWORDS_SNEASEL|$KEYWORDS_SNIVY|$KEYWORDS_SNORLAX|$KEYWORDS_SNORUNT|$KEYWORDS_SNOVER|$KEYWORDS_SNUBBULL|$KEYWORDS_SOLOSIS|$KEYWORDS_SOLROCK|$KEYWORDS_SPEAROW|$KEYWORDS_SPHEAL|$KEYWORDS_SPINARAK|$KEYWORDS_SPINDA|$KEYWORDS_SPIRITOMB|$KEYWORDS_SPOINK|$KEYWORDS_SQUIRTLE|$KEYWORDS_STANTLER|$KEYWORDS_STARAPTOR|$KEYWORDS_STARAVIA|$KEYWORDS_STARLY|$KEYWORDS_STARMIE|$KEYWORDS_STARYU|$KEYWORDS_STEELIX|$KEYWORDS_STOUTLAND|$KEYWORDS_STUNFISK|$KEYWORDS_STUNKY|$KEYWORDS_SUDOWOODO|$KEYWORDS_SUICUNE|$KEYWORDS_SUNFLORA|$KEYWORDS_SUNKERN|$KEYWORDS_SURSKIT|$KEYWORDS_SWABLU|$KEYWORDS_SWADLOON|$KEYWORDS_SWALOT|$KEYWORDS_SWAMPERT|$KEYWORDS_SWANNA|$KEYWORDS_SWELLOW|$KEYWORDS_SWINUB|$KEYWORDS_SWOOBAT"
