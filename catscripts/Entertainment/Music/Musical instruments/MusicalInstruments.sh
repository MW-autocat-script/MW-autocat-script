...
KEYWORDS_MUSICALINSTRUMENT_EXCLUDE="$KEYWORDS_CELLO|$KEYWORDS_CLARINET|$KEYWORDS_DRUMS|$KEYWORDS_FLUTE|$KEYWORDS_GUITAR|$KEYWORDS_HARP|$KEYWORDS_OBOE|$KEYWORDS_PIANO|$KEYWORDS_RECORDER|$KEYWORDS_SAXOPHONE|$KEYWORDS_VIOLA|$KEYWORDS_VIOLIN|$KEYWORDS_XYLOPHONE"
