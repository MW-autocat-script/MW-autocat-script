...
KEYWORDS_SINGERS_MARIAHCAREY="Mariah(| )Carey"
...
then
  ...
  MCAREY=$(egrep -i "$KEYWORDS_SINGERS_MARIAHCAREY" "$NEWPAGES")
  ...
  categorize "MCAREY" "Mariah Carey"
