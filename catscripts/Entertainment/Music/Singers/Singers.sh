...
KEYWORDS_SINGERS_EXCLUDE="sewing(| )machine|$KEYWORDS_SINGERS_AKON|$KEYWORDS_SINGERS_ASHLEYTSIDALE|$KEYWORDS_SINGERS_BEYONCE|$KEYWORDS_SINGERS_BOBMARLEY|$KEYWORDS_SINGERS_BRITNEYSPEARS|$KEYWORDS_SINGERS_DEMILOVATO|$KEYWORDS_SINGERS_BOBDYLAN|$KEYWORDS_SINGERS_ELTONJOHN|$KEYWORDS_SINGERS_ELVISPRESLEY|$KEYWORDS_SINGERS_EMINEM|$KEYWORDS_SINGERS_JOEJONAS|$KEYWORDS_SINGERS_JOHNLENNON|$KEYWORDS_SINGERS_JOHNNYCASH|$KEYWORDS_SINGERS_JOSHRAMSAY|$KEYWORDS_SINGERS_JUSTINBIEBER|$KEYWORDS_SINGERS_LADYGAGA|$KEYWORDS_SINGERS_LILWAYNE|$KEYWORDS_SINGERS_MADONNA|$KEYWORDS_SINGERS_MICHAELJACKSON|$KEYWORDS_SINGERS_MILEYCYRUS|$KEYWORDS_SINGERS_NICKJONAS|$KEYWORDS_SINGERS_RAYCHARLES|$KEYWORDS_SINGERS_RIHANNA|$KEYWORDS_SINGERS_TAYLORSWIFT|$KEYWORDS_SINGERS_TUPACSHAKUR|$KEYWORDS_SINGERS_VANESSAHUDGENS|$KEYWORDS_SINGERS_WHITNEYHOUSTON|$KEYWORDS_SINGERS_STEVIEWONDER"
...
egrep -i "$KEYWORDS_SINGERS_RAYCHARLES" newpages.txt >> RayCharles.txt
egrep -i "$KEYWORDS_SINGERS_MILEYCYRUS" newpages.txt >> MileyCyrus.txt
egrep -i "$KEYWORDS_SINGERS_BOBDYLAN" newpages.txt >> BobDylan.txt
...
egrep -i "$KEYWORDS_SINGERS_STEVIEWONDER" newpages.txt >> StevieWonder.txt
...
CHARLES=`stat --print=%s RayCharles.txt`
MCYRUS=`stat --print=%s MileyCyrus.txt`
DYLAN=`stat --print=%s BobDylan.txt`
...
WONDER=`stat --print=%s StevieWonder.txt`
