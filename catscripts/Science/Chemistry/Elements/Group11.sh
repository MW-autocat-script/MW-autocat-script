...
KEYWORDS_SILVER_EXCLUDE="Pokemon|Pokémon|Soul(| )Silver|Silver(| )Surfer|Silverado|Rune(| )Scape|Hedgehog|(Dragon Age|DragonAge)|MHFU|Monster Hunter|medal|membership|silverlight|Silverstone|(get|catch).+in silver$|penny|nickel|dime|quarter|dollar|gorilla|quick(| )silver|Silver(| )Sable|Long(| )John|hair|Ron(| )Silver|Silver(| )bell|Silver(| )fern|silver(| )certificate|free(| )silver|(Mt(|\.)|Mount)(| )Silver"
