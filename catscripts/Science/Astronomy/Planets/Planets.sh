...
egrep -i 'Planet' newpages.txt | egrep -iv 'Mercury|Venus|Earth|Mars|Jupiter|Saturn|Uranus|Neptune|Pluto|Eris|Dwarf planet|Captain Planet|Krypton|(Literacy|Litracy) planet|Planet of the Symbiotes|BlackPlanet|FilePlanet|deadly planet|planet turtle|LittleBigPlanet|Little Big Planet|Star Wars|Star Trek' > Planets.txt
...
egrep -i 'Venus\b' newpages.txt | egrep -iv 'god|deity|rome|roman|olympus|greece|myth|story|fly(| )trap|Venus, Florida|Star Wars|Star Trek|Venus(| )Williams' >> Venus.txt
