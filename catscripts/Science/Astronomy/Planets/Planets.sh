...
egrep -i 'Planet' newpages.txt | egrep -iv 'Mercury|Venus|Earth|Mars|Jupiter|Saturn|Uranus|Neptune|Pluto|Dwarf planet|Captain Planet|Krypton|(Literacy|Litracy) planet|Planet of the Symbiotes|BlackPlanet|FilePlanet|deadly planet|planet turtle|LittleBigPlanet|Little Big Planet' > Planets.txt
...
egrep -i '\bEarth\b' newpages.txt | egrep -iv 'earthquake|earth-shaking|earth-moving|earth-mover|earth-two|Fallen Earth|Earth( |-)(982|928|616)|X-Men|Kitty Pryde|Adam Warlock|Enchantress|Protector of Earth|Google Earth|Silverfall|Earth wire' >> Earth.txt
