...
egrep -i '\bEarth\b' newpages.txt | egrep -iv 'earthquake|earth-shaking|earth-moving|earth-mover|earth-two|Fallen Earth|Earth( |-)(982|928|616)|X-Men|Kitty Pryde|Adam Warlock|Enchantress|Protector of Earth|Google Earth|Silverfall|Earth wire|Mass Effect|Star Wars|Star Trek|Earth rune' >> Earth.txt
