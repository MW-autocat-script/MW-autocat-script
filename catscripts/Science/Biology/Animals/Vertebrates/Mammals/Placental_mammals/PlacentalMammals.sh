...
then
  ...
  KEYWORDS_PLACENTALEXCLUDE="$KEYWORDS_AARDVARKS_ALL|$KEYWORDS_ARMADILLOS_ALL|$KEYWORDS_BATS_ALL|$KEYWORDS_DOLPHINS|$KEYWORDS_HEDGEHOGS_ALL|$KEYWORDS_SLOTHS_ALL"
  KEYWORDS_PLACENTALMAMMALS_ALL="$KEYWORDS_PLACENTALMAMMALS|$KEYWORDS_AARDVARKS_ALL|$KEYWORDS_ARMADILLOS_ALL|$KEYWORDS_BATS_ALL|$KEYWORDS_DOLPHINS|$KEYWORDS_HEDGEHOGS_ALL|$KEYWORDS_SLOTHS_ALL"
