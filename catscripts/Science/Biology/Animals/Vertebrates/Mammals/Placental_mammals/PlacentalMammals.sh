...
then
  ...
  KEYWORDS_PLACENTALEXCLUDE="$KEYWORDS_AARDVARKS_ALL|$KEYWORDS_ANTEATERS_ALL|$KEYWORDS_ARMADILLOS_ALL|$KEYWORDS_BATS_ALL|$KEYWORDS_CAMELS_ALL|$KEYWORDS_DOLPHINS|$KEYWORDS_DUGONGS_ALL|$KEYWORDS_ELEPHANTS_ALL|$KEYWORDS_HARES_ALL|$KEYWORDS_HEDGEHOGS_ALL|$KEYWORDS_HIPPOS_ALL|$KEYWORDS_LLAMAS_ALL|$KEYWORDS_MANATEES_ALL|$KEYWORDS_PECCARIES_ALL|$KEYWORDS_PIGS_ALL|$KEYWORDS_PIKAS_ALL|$KEYWORDS_PORPOISES_ALL|$KEYWORDS_RABBITS_ALL|$KEYWORDS_SHREWS_ALL|$KEYWORDS_SLOTHS_ALL|$KEYWORDS_WHALES_ALL"
