...
then
  ...
  KEYWORDS_RODENTS_EXCLUDE="$KEYWORDS_BEAVERS_ALL|$KEYWORDS_GROUNDHOGS_ALL|$KEYWORDS_GUINEAPIGS_ALL|$KEYWORDS_PORCUPINES_ALL|$KEYWORDS_PRAIRIEDOGS_ALL|$KEYWORDS_SQUIRRELS_ALL"
  KEYWORDS_RODENTS_ALL="$KEYWORDS_RODENTS|$KEYWORDS_BEAVERS_ALL|$KEYWORDS_GROUNDHOGS_ALL|$KEYWORDS_GUINEAPIGS_ALL|$KEYWORDS_PORCUPINES_ALL|$KEYWORDS_PRAIRIEDOGS_ALL|$KEYWORDS_SQUIRRELS_ALL"
