...
KEYWORDS_CHAMELEONS="Chameleon"
KEYWORDS_SKINKS="Skink"
KEYWORDS_LIZARDS_EXCLUDE="$KEYWORDS_CHAMELEONS|$KEYWORDS_IGUANAS|$KEYWORDS_BEARDEDDRAGONS|$KEYWORDS_GECKOS|$KEYWORDS_SKINKS"
KEYWORDS_LIZARDS_ALL="$KEYWORDS_LIZARDS|$KEYWORDS_CHAMELEONS|$KEYWORDS_IGUANAS|$KEYWORDS_BEARDEDDRAGONS|$KEYWORDS_GECKOS|$KEYWORDS_SKINKS"
...
then
  ...
  CHAMELEONS=$(egrep -i "$KEYWORDS_CHAMELEONS" "$NEWPAGES")
  ...
  categorize "CHAMELEONS" "Chameleons"
