...
egrep -i 'England|British' newpages.txt | egrep -iv 'British Isles|London|Church of England|New England|Stonehenge' >> England.txt #Since most people don't know the difference between British and English
