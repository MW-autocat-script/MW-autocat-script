...
KEYWORDS_USMILITARY="\bdod\b|Department(| )of(| )Defense|(U(|\.)S(|\.)|United(| )States)(| )military"
KEYWORDS_USMC="(U(|\.)S(|\.)|United(| )States)(| )Marine(|s)(| )(|Corps)|USMC"
KEYWORDS_USARMY="(U(|\.)S(|\.)|United(| )States)(| )Army"
KEYWORDS_USAIRFORCE="(U(|\.)S(|\.)|United(| )States)(| )(|ch)Air(| )Force|USAF\b"
KEYWORDS_USNAVY="(U(|\.)S(|\.)|United(| )States)(| )Navy|\bUSN\b"
KEYWORDS_USCG="(U(|\.)S(|\.)|United(| )States)(| )Coast(| )Guard|USCG"
