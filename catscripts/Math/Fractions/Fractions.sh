...
egrep -i 'in lowest terms\]\]|reduced fraction' newpages.txt >> Fractions.txt
...
egrep -i '[0-9]{1,}(/|\\)[0-9]{1,}(| )(plus|minus|times|divided(| )by)(| )[0-9]{1.} [0-9]{1,}(/|\\)[0-9]{1,}' newpages.txt >> Fractions.txt
